...
class ND_MigsVpc_ServerController extends ND_MigsVpc_Controller_Abstract
{
    ...
    public function responseAction()
    {
        ...
        if($responseParams['vpc_TxnResponseCode']=='7')
        {
        	...
        	Mage::getSingleton('core/session')->addError("We're sorry, but your transaction has been declined or was otherwise unsuccessful. Please try again or contact your bank to resolve the issue.");
