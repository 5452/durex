...
class Mage_Sales_Model_Order_Pdf_Invoice extends Mage_Sales_Model_Order_Pdf_Abstract
{
    public function getPdf($invoices = array())
    {
        ...
        foreach ($invoices as $invoice) {
            ...
            $this->insertRBLogo($page, $invoice->getStore());
            /* Add address */
            ...
            $page->drawLine(25, 795, 570, 794);
            $page->drawLine(25, 745, 570, 744);
            ...
            $page->drawText(Mage::helper('sales')->__('Subtotal'), 510, $this->y, 'UTF-8');
        ...
        $page->drawText("Thank you again, Durexjoy Customer Service Team", 340, $this->y-20, 'UTF-8');
